            ...
            <div className="flex-grow max-w-7xl mx-auto px-6 py-16 w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    {staff.map((person, index) => (
                        <div key={index} className={`rounded-3xl overflow-hidden shadow-xl transition-all duration-300 hover:-translate-y-2 flex flex-col group ${theme === 'dark' ? 'bg-gray-800/80 backdrop-blur-sm border border-gray-700/50' : 'bg-white/80 backdrop-blur-sm border border-gray-100'}`}>
