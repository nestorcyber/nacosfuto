        ...
        <div className={`min-h-screen flex flex-col ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
            ...
            <div className="flex-grow max-w-5xl mx-auto px-6 py-16 w-full">
                ...
                <section>
                    ...
                    <div className="relative border-l-4 border-blue-500/30 ml-4 md:ml-10 space-y-6">
                        {rainEvents.map((event, index) => (
                            <div key={index} className="relative pl-8 md:pl-12">
                                <div className="absolute -left-[14px] top-1 w-6 h-6 rounded-full border-4 bg-blue-500 border-blue-200 z-10 box-content"></div>
                                <div className={`p-5 rounded-2xl shadow-lg border transition-all hover:shadow-xl ${theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-100'}`}>
