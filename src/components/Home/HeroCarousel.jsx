  ...
  return (
    <section className="w-full relative pb-1 px-0 md:px-0 max-w-7xl mx-auto">
                  ...
                  <div className="max-w-2xl w-full">
                    ...
                    {slide.button && (
                      <ScrollToTopLink
                        ...
                        className="inline-block px-5 py-2 bg-green-600 hover:bg-green-700 rounded-md font-medium transition-colors"
                      >
                        {slide.button.text}
                      </ScrollToTopLink>
                    )}
      ...
      <div className="hidden md:grid grid-cols-2 gap-8 items-center h-[500px]">
        <div
          className="relative w-full h-full rounded-xl overflow-hidden shadow-xl group"
          onMouseEnter={() => setAutoScroll(false)}
          onMouseLeave={() => setAutoScroll(true)}
        >
          {/* Slides */}
        ...
        <div className="flex flex-col justify-center pl-8">
          ...
          <ScrollToTopLink
            to="/signup"
            className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded font-bold shadow-lg transition"
          >
            Get Started
          </ScrollToTopLink>
