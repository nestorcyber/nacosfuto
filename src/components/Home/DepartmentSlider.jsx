...
const DepartmentSlider = () => {
  ...
  return (
    <section className="py-16 bg-gray-50 dark:bg-gray-800 section-content">
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-8 dark:text-white">
          Department Highlights
        </h2>

        <div className="relative h-96 rounded-3xl overflow-hidden shadow-2xl group mx-2 md:mx-0">
          {/* Slides */}
