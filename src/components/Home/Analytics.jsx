    ...
    <section className="py-24 bg-[#f4faf3] dark:bg-[#041801] transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h2 className="text-3xl sm:text-4xl font-black mb-4 text-[#083002] dark:text-white tracking-tight leading-tight">
            Comprehensive <span className="bg-gradient-to-r from-[#138601] to-[#3db92c] bg-clip-text text-transparent">Academic Framework</span>
          </h2>
          <p className="text-[#083002]/75 dark:text-green-100/75 mb-8 text-base sm:text-lg leading-relaxed">
          ...
          <div className="space-y-5">
            <div className="flex items-start gap-4 p-4 rounded-2xl bg-white dark:bg-[#083002] border border-[#138601]/15 dark:border-[#138601]/30 shadow-sm">
              <div className="w-10 h-10 rounded-xl bg-[#138601]/10 dark:bg-[#138601]/25 flex items-center justify-center text-[#138601] dark:text-[#4bd043] text-lg flex-shrink-0">
                <FaUserShield />
              </div>
              <div>
        ...
        <div className="flex justify-center">
          <div className="bg-white dark:bg-[#083002] p-8 rounded-3xl shadow-xl border border-[#138601]/20 dark:border-[#138601]/30 w-full max-w-md">
            <div className="flex items-center gap-3 mb-4 pb-4 border-b border-[#138601]/15 dark:border-white/10">
              <div className="w-12 h-12 rounded-2xl bg-[#138601] flex items-center justify-center text-white text-xl shadow-md shadow-[#138601]/30">
                <FaGraduationCap />
              </div>
              <div>
            ...
            <p className="mb-6 text-sm text-[#083002]/75 dark:text-green-100/75 leading-relaxed">
              Explore academic roadmaps, departmental handbooks, lecture materials, and faculty directories.
            </p>
            <ScrollToTopLink to="/academics" className="block w-full py-3.5 bg-[#138601] hover:bg-[#0f6c01] text-white text-center rounded-xl font-bold text-sm transition-all shadow-md shadow-[#138601]/30">
