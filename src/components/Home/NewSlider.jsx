...
const NewsSlider = () => {
  ...
  return (
    <section className="relative dark:bg-gray-900 py-12 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-8 text-gray-800 dark:text-white">
          Department <span className="text-green-600">News & Events</span>
        </h2>

        <div
          className="relative h-96 rounded-3xl overflow-hidden shadow-2xl mx-2 md:mx-0"
        ...
        >
          ...
          {slides.map((slide, index) => (
            ...
            >
              ...
              />
              <div className="absolute left-0 right-0 bottom-0 text-left text-white px-8 pb-12 pt-8 z-10">
                <div className="max-w-2xl w-full">
                  ...
                  <a
                    href={slide.link}
                    className="inline-block px-6 py-3 bg-green-600 hover:bg-green-700 rounded-md font-medium transition-colors"
                  >
                    Learn More
                  </a>
                </div>
