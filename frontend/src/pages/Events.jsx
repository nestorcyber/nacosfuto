...
const Events = () => {
  ...
  // Upcoming Events Data (Future relative to July 19, 2026)
  ...
  // Recent Events Data (Within past 2 months: July 19, 2026 back to May 19, 2026)
  const recentEvents = [
    {
      id: 13,
  ...
  const pastEvents = [
    ...
    },
    {
      ...
      image: eventNacosThanksgivingMass,
  ...
  return (
    <div className={`min-h-screen flex flex-col ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'} transition-colors duration-300`}>
      ...
      <div className="flex-grow max-w-7xl mx-auto px-6 py-16 w-full">
        ...
        {/* 2. Recent Events Section (Priority Top 3) */}
        <section className="mb-20">
          <div className="flex items-center gap-4 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {recentEvents.map(event => (
              ...
              >
                <div className="lg:w-2/5 h-56 lg:h-auto overflow-hidden relative">
                  <img src={event.image} alt={event.title} className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700" />
                  <div className="absolute top-4 left-4 bg-blue-600 text-white px-3 py-1.5 rounded-lg font-bold text-xs shadow">
                     RECENT
                  </div>
                </div>
                <div className="p-8 lg:w-3/5 flex flex-col justify-between text-gray-900 dark:text-white">
        ...
        {/* 3. Past Events Section (Older Events) */}
        <section>
          <div className="flex items-center gap-4 mb-8">
