...
const ResourcesPage = () => {
  ...
  // Authentication State (combines portal localStorage with upskill storeUser)
  ...
  // Preview Handler: Direct Fullscreen Preview (Free for all students and visitors)
  ...
  const getResourceIcon = (type, ext) => {
    ...
    if (clean.includes('video') || clean.includes('mp4')) {
      return <FiVideo className="text-3xl sm:text-4xl text-[#1d72fe]" />;
    }
    if (clean.includes('book')) {
      return <FiBook className="text-3xl sm:text-4xl text-[#1d72fe]" />;
    }
    return <FiFileText className="text-3xl sm:text-4xl text-[#1d72fe]" />;
  };

  // Hero carousel slides inspired by literature & academic archive hero layout
  ...
  return (
    <div className="flex-1 flex flex-col bg-white dark:bg-[#000000] text-gray-900 dark:text-white transition-colors duration-300">
      
      {/* Toast notification banner */}
      {toastMessage && (
        <div className="fixed top-20 right-6 z-50 p-3.5 rounded bg-white dark:bg-[#07101e] border border-blue-500/40 text-gray-900 dark:text-white shadow-xl flex items-center gap-2.5 animate-in fade-in slide-in-from-top-3 duration-200">
          {toastMessage.type === 'error' ? (
            <FiAlertCircle className="w-4 h-4 text-red-500" />
          ) : (
            <FiCheckCircle className="w-4 h-4 text-[#0056D2] dark:text-[#1d72fe]" />
          )}
      ...
      <div className="bg-[#07101e] border-b border-[#0056D2]/30 py-2 sm:py-2.5 px-3 sm:px-4 sticky top-16 z-20 shadow-md">
        <div className="site-container flex flex-col md:flex-row items-stretch md:items-center justify-between gap-2.5 sm:gap-4">
          ...
          <div className="flex items-center justify-between gap-2 w-full md:w-auto">
            <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
              <div className="w-7 h-7 sm:w-8 sm:h-8 rounded bg-[#0056D2] flex items-center justify-center text-white shadow-xs font-black text-xs sm:text-sm">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              <select
                ...
                className="px-2 py-1.5 rounded bg-[#000000] text-xs font-medium text-white border border-[#0056D2]/40 focus:outline-none focus:ring-1 focus:ring-[#1d72fe] transition-colors cursor-pointer"
              >
                <option value="All Levels" className="bg-[#07101e] text-white">All Levels</option>
                <option value="100 Level" className="bg-[#07101e] text-white">100L</option>
                <option value="200 Level" className="bg-[#07101e] text-white">200L</option>
                <option value="300 Level" className="bg-[#07101e] text-white">300L</option>
                <option value="400 Level" className="bg-[#07101e] text-white">400L</option>
                <option value="500 Level" className="bg-[#07101e] text-white">500L</option>
              </select>
              ...
              <select
                ...
                className="px-2 py-1.5 rounded bg-[#000000] text-xs font-medium text-white border border-[#0056D2]/40 focus:outline-none focus:ring-1 focus:ring-[#1d72fe] transition-colors cursor-pointer"
              >
                <option value="All Semesters" className="bg-[#07101e] text-white">All Terms</option>
                <option value="First Semester" className="bg-[#07101e] text-white">1st Sem</option>
                <option value="Second Semester" className="bg-[#07101e] text-white">2nd Sem</option>
              </select>
            </div>
            ...
            <div className="shrink-0">
              {user ? (
                <a
                  ...
                  className="text-xs text-white hover:text-[#1d72fe] font-semibold transition-colors truncate max-w-[90px] sm:max-w-none inline-block"
                >
                  <span className="font-bold underline text-[#1d72fe]">{user.firstName || user.name || 'Student'}</span>
                </a>
              ) : (
                <button
                  type="button"
                  onClick={handleRedirectToSignIn}
                  className="text-xs text-white hover:text-[#1d72fe] font-semibold transition-colors cursor-pointer px-2 py-1 rounded hover:bg-white/5 whitespace-nowrap"
                >
                  Log in
                </button>
              )}
          ...
          <form onSubmit={handleHeroSearchSubmit} className="w-full md:flex-1 md:max-w-md lg:max-w-lg">
            <div className="relative flex items-center w-full shadow-xs">
              <input
                ...
                className="w-full bg-white text-gray-900 placeholder-gray-400 text-xs sm:text-sm pl-3 pr-10 py-1.5 sm:py-2 rounded border border-transparent focus:outline-none focus:ring-2 focus:ring-[#1d72fe] transition-all"
              />
              {searchQuery && (
                <button
                  type="button"
              ...
              <button
                type="submit"
                aria-label="Search"
                className="absolute right-0 top-0 bottom-0 px-3 bg-[#0056D2] hover:bg-[#0043aa] text-white flex items-center justify-center rounded-r transition-colors cursor-pointer"
              >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center flex flex-col items-center">
          ...
          <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm text-gray-200/95 max-w-2xl font-normal leading-relaxed drop-shadow-md line-clamp-2 sm:line-clamp-none">
            ...
            <button
              ...
              className="text-[#1d72fe] hover:text-[#38bdf8] font-bold underline transition-colors cursor-pointer ml-1 inline-flex items-center gap-0.5"
            >
      ...
      <main id="catalog-section" className="flex-grow site-container w-full py-8 sm:py-10">
        ...
        {/* Catalog Header Bar */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 mb-6 border-b border-[#0056D2]/20 dark:border-[#0056D2]/30 gap-3">
          <div>
            <h2 className="text-xl sm:text-2xl font-extrabold text-[#07101e] dark:text-white tracking-tight flex items-center gap-2">
              <span>Catalog & Archive</span>
              <span className="text-xs font-semibold px-2.5 py-0.5 rounded bg-[#0056D2]/10 dark:bg-[#0056D2]/30 text-[#0056D2] dark:text-[#1d72fe]">
          ...
          <div className="flex items-center gap-2">
            ...
            {user ? (
              ...
              <button
                type="button"
                onClick={handleRedirectToSignIn}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded bg-[#0056D2] hover:bg-[#0043aa] text-white text-xs font-semibold transition-colors shadow-xs cursor-pointer"
              >
              ...
              <button
                ...
                className={`px-3 sm:px-3.5 py-1.5 rounded font-semibold text-xs whitespace-nowrap transition-colors cursor-pointer border shrink-0 ${
                  activeCategory === cat
                    ...
                    : 'bg-[#eef5ff] dark:bg-[#07101e] text-[#07101e] dark:text-blue-100 border-[#0056D2]/20 dark:border-[#0056D2]/30 hover:bg-[#e2f7df] dark:hover:bg-[#0056D2]/20'
                }`}
              >
                {cat}
              </button>
          ...
          <div className="flex items-center justify-between sm:justify-end gap-3 text-xs">
            {hasActiveFilters && (
              <button
                ...
                className="inline-flex items-center gap-1.5 text-xs text-[#0056D2] dark:text-[#1d72fe] font-semibold hover:underline cursor-pointer"
              >
                <FiRefreshCw className="w-3 h-3" />
                <span>Reset Filters</span>
              </button>
            )}
            <span className="text-xs text-gray-500 dark:text-blue-200/70 font-medium">
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="bg-[#f8fdf7] dark:bg-[#07101e] rounded border border-[#0056D2]/20 p-4 sm:p-5 space-y-4 animate-pulse">
                <div className="h-32 bg-gray-200 dark:bg-[#000000] rounded"></div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {resources.map((resource) => {
              ...
              return (
                <div
                  key={resource.id}
                  className="bg-[#f8fdf7] dark:bg-[#07101e] rounded overflow-hidden shadow-xs hover:shadow-md transition-all duration-300 border border-[#0056D2]/20 dark:border-[#0056D2]/30 flex flex-col justify-between group"
                >
                  {/* Card Visual Header */}
                  <div className="h-32 sm:h-36 bg-[#000000] flex items-center justify-center text-white border-b border-[#0056D2]/20 relative overflow-hidden">
                    {isVideo && (resource.thumbnail_storage_key || resource.thumbnail_key) ? (
                      <div className="relative w-full h-full">
                        ...
                        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                          <div className="w-10 h-10 rounded-full bg-[#0056D2] text-white flex items-center justify-center shadow-md">
                  ...
                  <div className="p-4 sm:p-5 flex-grow flex flex-col justify-between space-y-3 sm:space-y-4">
                    <div>
                      ...
                      <div className="flex justify-between items-center mb-1.5">
                        <span className="text-xs font-bold text-[#0056D2] dark:text-[#1d72fe] bg-emerald-50 dark:bg-[#000000] px-2 py-0.5 rounded border border-[#0056D2]/25">
                          {resource.course_code || 'GEN'}
                        </span>
                        <span className="text-[11px] text-gray-500 dark:text-blue-200/70 font-medium">
                          {resource.category?.name || resource.resource_type || 'Material'}
                        </span>
                      </div>

                      {/* Course Title + Level & Semester Badges */}
                      <div className="flex flex-wrap sm:flex-nowrap items-baseline justify-between gap-x-2 gap-y-1">
                        <h3 className="text-sm sm:text-base font-bold text-[#07101e] dark:text-white leading-snug group-hover:text-[#0056D2] dark:group-hover:text-[#1d72fe] transition-colors flex-1 min-w-[140px] break-words">
                          {resource.title}
                        </h3>
                        ...
                        <div className="flex items-center gap-1.5 shrink-0 mt-0.5 sm:mt-0">
                          ...
                          {resource.semester && (
                            <span className="text-[10px] sm:text-[11px] font-semibold px-1.5 py-0.5 rounded bg-emerald-50 dark:bg-[#000000] text-[#0056D2] dark:text-[#1d72fe] border border-[#0056D2]/25 whitespace-nowrap">
                      ...
                      {(resource.author || resource.lecturer) && (
                        <p className="text-xs text-[#07101e]/70 dark:text-blue-100/70 mt-1.5 font-medium">
                    ...
                    <div className="pt-3 border-t border-[#0056D2]/15 dark:border-white/10 space-y-2.5">
                      <div className="flex items-center justify-between text-[11px] text-gray-500 dark:text-blue-200/70 font-mono">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <button
                          ...
                          className="w-full flex items-center justify-center gap-1.5 py-2 px-3 rounded text-xs font-semibold bg-white dark:bg-[#000000] hover:bg-[#0056D2]/10 dark:hover:bg-[#0056D2]/20 text-gray-800 dark:text-gray-200 border border-gray-200 dark:border-[#0056D2]/30 transition-colors cursor-pointer"
                        >
                        ...
                        <button
                          ...
                          className="w-full flex items-center justify-center gap-1.5 py-2 px-3 rounded text-xs font-semibold text-white bg-[#0056D2] hover:bg-[#0043aa] shadow-xs transition-colors cursor-pointer disabled:opacity-60"
                        >
          ...
          <div className="text-center py-16 px-4 bg-[#f8fdf7] dark:bg-[#07101e] rounded border border-dashed border-[#0056D2]/30">
            ...
            <button
              onClick={handleResetFilters}
              className="mt-4 px-4 py-2 bg-[#0056D2] hover:bg-[#0043aa] text-white font-semibold rounded text-xs transition-colors shadow-xs cursor-pointer"
            >
              Reset All Filters
            </button>
          </div>
      ...
      {isSignInModalOpen && (
        <div className="fixed inset-0 z-[110] bg-black/80 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white dark:bg-[#07101e] border border-gray-200 dark:border-[#0056D2]/40 rounded w-full max-w-md shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-150 p-6 space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                <div className="w-9 h-9 rounded bg-[#0056D2]/15 text-[#0056D2] dark:text-[#1d72fe] flex items-center justify-center">
                  <FiLock className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="text-base font-bold text-gray-900 dark:text-white">Portal Sign-In Required</h3>
                  <p className="text-[11px] text-gray-500 dark:text-blue-200/70">NACOS FUTO Academic Portal</p>
                </div>
              </div>
              <button
                type="button"
                ...
                className="p-1.5 rounded text-gray-400 hover:text-gray-700 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-[#000000] transition-colors cursor-pointer"
              >
                <FiX className="w-4 h-4" />
              </button>
            </div>

            <div className="p-3.5 rounded bg-[#f8fafc] dark:bg-[#000000] border border-gray-200 dark:border-[#0056D2]/30 space-y-2">
              <p className="text-xs text-gray-700 dark:text-blue-100 leading-relaxed">
              ...
              {targetResource && (
                <div className="pt-2 border-t border-gray-200 dark:border-[#0056D2]/20">
                  <p className="text-[11px] text-gray-500 dark:text-blue-200/70 font-semibold truncate">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-2 pt-2">
              <button
                ...
                className="w-full sm:w-auto flex-1 px-4 py-2.5 rounded text-xs font-semibold text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-[#000000] hover:bg-gray-200 dark:hover:bg-[#0056D2]/20 border border-gray-200 dark:border-[#0056D2]/30 transition-colors cursor-pointer text-center"
              >
                Cancel
              </button>
              <button
                type="button"
                onClick={handleRedirectToSignIn}
                className="w-full sm:w-auto flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded text-xs font-semibold text-white bg-[#0056D2] hover:bg-[#0043aa] shadow-xs transition-colors cursor-pointer"
              >
      ...
      {activePreviewResource && (
        <div className="fixed inset-0 z-[100] bg-black flex flex-col w-screen h-screen overflow-hidden animate-in fade-in duration-150">
          ...
          <div className="w-full px-4 sm:px-6 py-2.5 sm:py-3 bg-[#07101e] border-b border-[#0056D2]/40 flex items-center justify-between gap-3 shrink-0 text-white shadow-xl z-20">
            <div className="flex items-center gap-2 sm:gap-2.5 min-w-0">
              {activePreviewResource.course_code && (
                <span className="text-xs font-bold px-2 py-0.5 rounded bg-[#0056D2] text-white shadow-xs shrink-0">
                  {activePreviewResource.course_code}
                </span>
              )}
              <div className="min-w-0">
                ...
                <p className="text-[11px] text-blue-200/70 font-mono truncate hidden sm:block">
            ...
            <div className="flex items-center gap-2 sm:gap-3 shrink-0">
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 sm:px-4 py-1.5 rounded text-xs font-semibold text-white bg-[#0056D2] hover:bg-[#0043aa] shadow-xs transition-colors cursor-pointer"
              >
          ...
          <div className="flex-1 w-full h-full overflow-hidden bg-neutral-950 flex flex-col relative">
            {isLoadingPreview ? (
              <div className="flex-1 flex flex-col items-center justify-center space-y-3">
                <div className="w-10 h-10 border-3 border-[#0056D2] border-t-transparent rounded-full animate-spin"></div>
              ...
              <>
                ...
                {!['pdf', 'mp4', 'jpg', 'jpeg', 'png', 'webp'].includes(activePreviewResource.file_extension) && (
                  <div className="flex-1 flex flex-col items-center justify-center p-6 text-center space-y-3">
                    <FiFileText className="w-16 h-16 text-[#1d72fe]" />
                    ...
                    <button
                      type="button"
                      onClick={() => handleDownloadClick(activePreviewResource)}
                      className="inline-flex items-center gap-2 px-5 py-2.5 rounded text-xs font-bold text-white bg-[#0056D2] hover:bg-[#0043aa] shadow-md transition-colors cursor-pointer"
                    >
