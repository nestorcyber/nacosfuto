...
const CountdownTimer = ({ targetDate = "2026-09-08T09:00:00Z", label = "Registration Closes In" }) => {
  ...
  return (
    <div className="bg-white dark:bg-[#083002] border border-gray-200 dark:border-[#138601]/30 rounded p-4 md:p-6 shadow-sm">
      ...
      <div className="grid grid-cols-4 gap-2 md:gap-3 text-center">
        <div className="bg-gray-50 dark:bg-[#041801] border border-gray-200 dark:border-[#138601]/25 rounded p-2.5 md:p-3">
