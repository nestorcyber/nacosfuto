      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-3.5 py-2 rounded text-xs font-semibold text-white bg-[#138601] hover:bg-[#0f6c01] transition-colors cursor-pointer shrink-0 shadow-xs"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-4 sm:p-5 rounded bg-white dark:bg-[#083002] border border-gray-200 dark:border-[#138601]/30 space-y-1 shadow-xs">
        ...
        {filteredSemesters.length === 0 ? (
          <div className="p-8 rounded bg-white dark:bg-[#083002] border border-gray-200 dark:border-[#138601]/30 text-center space-y-2">
          ...
          <div className="space-y-6">
            {filteredSemesters.map((sem) => (
              <div
                key={sem.id}
                className="rounded bg-white dark:bg-[#083002] border border-gray-200 dark:border-[#138601]/30 overflow-hidden shadow-xs"
              >
                {/* Semester Header */}
                <div className="p-3.5 sm:p-4 border-b border-gray-200 dark:border-[#138601]/25 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  <div>
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-semibold text-gray-900 dark:text-[#4bd043] bg-[#f1f3f5] dark:bg-[#041801] px-3 py-1 rounded">
                  ...
                  <table className="w-full text-left text-xs">
                    <thead className="bg-[#f8fafc] dark:bg-[#041801]/60 text-gray-600 dark:text-green-200 font-semibold border-b border-gray-200 dark:border-[#138601]/30">
                      <tr>
                        ...
                        <th className="py-2.5 px-3">Course Description</th>
                        <th className="py-2.5 px-3 text-center">Units</th>
                        <th className="py-2.5 px-3 text-center">Test (30)</th>
                    ...
                    <tbody className="divide-y divide-gray-100 dark:divide-[#138601]/15 font-normal">
                      {sem.courses.map((course, idx) => (
                        <tr key={idx} className="hover:bg-gray-50/70 dark:hover:bg-[#041801]/40 transition-colors">
                          <td className="py-2.5 px-3 font-semibold text-gray-900 dark:text-white">{course.code}</td>
                          <td className="py-2.5 px-3 text-gray-600 dark:text-green-100">{course.title}</td>
                          <td className="py-2.5 px-3 text-center text-gray-600 dark:text-green-100">{course.units}</td>
                          <td className="py-2.5 px-3 text-center text-gray-600 dark:text-green-100">{course.test}</td>
                          <td className="py-2.5 px-3 text-center text-gray-600 dark:text-green-100">{course.exam}</td>
                          <td className="py-2.5 px-3 text-center font-semibold text-gray-900 dark:text-white">{course.score}%</td>
                          ...
                          <td className="py-2.5 px-3 text-right font-semibold text-gray-900 dark:text-white">{course.gp}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
