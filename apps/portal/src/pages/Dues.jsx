      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <button
            ...
            onClick={handlePrint}
            disabled={isPrinting}
            className="inline-flex items-center justify-center gap-2 px-3.5 py-2 rounded text-xs font-semibold text-white bg-[#138601] hover:bg-[#0f6c01] transition-colors cursor-pointer"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-4 rounded bg-white dark:bg-[#083002] border border-gray-200 dark:border-[#138601]/30 space-y-1">
            ...
            <div className="flex items-center gap-2 text-lg font-bold text-[#138601] dark:text-[#4bd043]">
          ...
          <div className="p-4 rounded bg-white dark:bg-[#083002] border border-gray-200 dark:border-[#138601]/30 space-y-1">
            ...
            <div className="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white font-mono">{paymentRecord.receiptNo}</div>
        ...
        <div className="p-5 sm:p-6 rounded bg-white dark:bg-[#083002] border border-gray-200 dark:border-[#138601]/40 space-y-5">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pb-4 border-b border-gray-200 dark:border-[#138601]/30 text-center sm:text-left">
            ...
            <div className="text-center sm:text-right">
              ...
              <div className="text-xs text-gray-500 dark:text-green-200/70 mt-0.5 font-mono">{paymentRecord.receiptNo}</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-3.5 gap-x-6 text-xs">
            ...
            <div>
              ...
              <span className="font-semibold text-xs sm:text-sm text-gray-900 dark:text-white">{paymentRecord.paymentDate}</span>
            </div>

            <div>
              <span className="text-gray-500 dark:text-green-200/70 block mb-0.5 text-[11px]">Payment Method</span>
              <span className="font-semibold text-xs sm:text-sm text-gray-900 dark:text-white">{paymentRecord.paymentMethod}</span>
            </div>
            ...
            <div className="sm:col-span-2 pt-3.5 border-t border-gray-100 dark:border-[#138601]/20 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                ...
                <span className="text-xl sm:text-2xl font-bold text-[#138601] dark:text-[#4bd043]">{paymentRecord.amount}</span>
                <span className="text-xs text-gray-500 dark:text-green-200/70 block italic font-normal mt-0.5">{paymentRecord.amountInWords}</span>
              </div>

              <div className="flex items-center space-x-2.5 p-2.5 rounded bg-[#f1f3f5] dark:bg-[#041801] border border-gray-200 dark:border-[#138601]/30">
                <QrCode className="w-8 h-8 text-gray-700 dark:text-[#4bd043]" />
