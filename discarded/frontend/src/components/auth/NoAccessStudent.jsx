...
const features = [
       ...
       },
       {
         ...
         title: "Staff Portal",
         description: "Manage academic records of students and access academic resources all in one place.",
   ...
   return (
    ...
    <div className="min-h-screen flex flex-col bg-white dark:bg-gray-900 transition-colors duration-200">
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <p className="text-xl font-bold text-center mb-6 text-gray-900 dark:text-white">You Cannot Access this page because you are not a Student</p>
...
export default NoAccessStudent;